...
READ_PATH = os.path.abspath(os.path.join(os.path.dirname( __file__ ), '../..', 'EECS3461\\Webpages'))
WRITE_PATH = os.path.abspath(os.path.join(os.path.dirname( __file__ ), '../..', 'EECS3461\\'))
