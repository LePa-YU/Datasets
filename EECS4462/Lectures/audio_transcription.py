...
READ_PATH = os.path.abspath(os.path.join(os.path.dirname( __file__ ), '..', 'EECS4462','EECS4462_Videos_F20_21'))
WRITE_AUDIO_PATH = os.path.abspath(os.path.join(os.path.dirname( __file__ ), '..', 'EECS4462','Lecture_Audio'))
WRITE_PATH = os.path.abspath(os.path.join(os.path.dirname( __file__ ), '..', 'EECS4462','Lecture_Transcripts'))
